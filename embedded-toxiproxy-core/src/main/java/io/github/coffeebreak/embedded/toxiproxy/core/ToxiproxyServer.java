...
public class ToxiproxyServer {
  ...
  @Getter private final ToxiproxyServerConfiguration configuration;
  ...
  public static class ToxiproxyServerConfiguration {
    @Getter @Builder.Default private String host = "localhost";

    @Getter @Builder.Default private int port = 8474;

    @Builder.Default private int timeout = 1000;

    @Builder.Default private boolean inheritIO = false;
  }
}
